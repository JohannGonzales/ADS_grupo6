  ...
  if ($filas==0) {
    ...
    //todos calificaron y obtuvo aprobacion unanime
      if ($registro1[0]==14) {
        ...
        $sentencia4="update calificacion_criterios a set ID_Trabajador = (SELECT a.id_trabajador from asignacion_comite a inner join trabajadores b on b.ID_Trabajador=a.ID_Trabajador where a.codigo_concurso=(SELECT codigo_concurso from proyectos where cod_postulacion='$cod_postulacion') and b.cargo_trabajador ='Especialista_gestion' group by codigo_concurso) where cod_postulacion='$cod_postulacion' and cod_criterio=9;";
        $sentencia5="update calificacion_criterios a set ID_Trabajador = (SELECT a.id_trabajador from asignacion_comite a inner join trabajadores b on b.ID_Trabajador=a.ID_Trabajador where a.codigo_concurso=(SELECT codigo_concurso from proyectos where cod_postulacion='$cod_postulacion') and b.cargo_trabajador ='Especialista_cambio' group by codigo_concurso) where cod_postulacion='$cod_postulacion' and cod_criterio=10;";
        $sentencia6="update calificacion_criterios a set ID_Trabajador = (SELECT a.id_trabajador from asignacion_comite a inner join trabajadores b on b.ID_Trabajador=a.ID_Trabajador where a.codigo_concurso=(SELECT codigo_concurso from proyectos where cod_postulacion='$cod_postulacion') and b.cargo_trabajador ='Especialista_tematica' group by codigo_concurso) where cod_postulacion='$cod_postulacion' and cod_criterio=11;";
        $sentencia7="update calificacion_criterios a set ID_Trabajador = (SELECT a.id_trabajador from asignacion_comite a inner join trabajadores b on b.ID_Trabajador=a.ID_Trabajador where a.codigo_concurso=(SELECT codigo_concurso from proyectos where cod_postulacion='$cod_postulacion') and b.cargo_trabajador ='Especialista_salva_amb' group by codigo_concurso) where cod_postulacion='$cod_postulacion' and cod_criterio=12;";
        $sentencia8="update calificacion_criterios a set ID_Trabajador = (SELECT a.id_trabajador from asignacion_comite a inner join trabajadores b on b.ID_Trabajador=a.ID_Trabajador where a.codigo_concurso=(SELECT codigo_concurso from proyectos where cod_postulacion='$cod_postulacion') and b.cargo_trabajador ='Especialista_salva_soc' group by codigo_concurso) where cod_postulacion='$cod_postulacion' and cod_criterio=13;";
