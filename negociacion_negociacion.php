...
<body>
  ...
  <table border=1>
		<?php
			...
			$query = "SELECT cod_concurso, nombre_concurso FROM concursos where etapa_concurso=4";
			...
			if ($num_rows == 0) {
				...
				for ($i=1; $i <= $num_rows; $i++){
					...
					echo "		<td><a href='negociacion_negociacion_.php?concurso_ID=$registro[0]'>Negociar</a> </td>";
					echo "	</tr>";
				}
				echo "</table>";
			}
